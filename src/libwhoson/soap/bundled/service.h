...
/// @brief "http://it.bmc.uu.se/whoson":LogonEventMatch is a simpleType restriction of XSD type xs:string.
///
...
/// @brief "http://it.bmc.uu.se/whoson":LogonEvent is a complexType.
///
...
/// @brief "http://it.bmc.uu.se/whoson":ArrayOfLogonEvent is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":CreateLogonEvent
/// @brief "http://it.bmc.uu.se/whoson":CreateLogonEvent is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":CreateLogonEventResponse
/// @brief "http://it.bmc.uu.se/whoson":CreateLogonEventResponse is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":CloseLogonEvent
/// @brief "http://it.bmc.uu.se/whoson":CloseLogonEvent is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":CloseLogonEventResponse
/// @brief "http://it.bmc.uu.se/whoson":CloseLogonEventResponse is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":DeleteLogonEvent
/// @brief "http://it.bmc.uu.se/whoson":DeleteLogonEvent is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":DeleteLogonEventResponse
/// @brief "http://it.bmc.uu.se/whoson":DeleteLogonEventResponse is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":FindLogonEvent
/// @brief "http://it.bmc.uu.se/whoson":FindLogonEvent is a complexType.
///
...
/// @brief Top-level root element "http://it.bmc.uu.se/whoson":FindLogonEventResponse
/// @brief "http://it.bmc.uu.se/whoson":FindLogonEventResponse is a complexType.
///
...
class _WhosOn__FindLogonEventResponse
{ public:
/// Element "FindLogonEventResult" of XSD type "http://it.bmc.uu.se/whoson":LogonEvent.
    WhosOn__LogonEvent*                  FindLogonEventResult           1;	///< Required element.
/// A handle to the soap struct that manages this instance (automatically set).
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://it.bmc.uu.se/whoson":FindLogonEvents
/// @brief "http://it.bmc.uu.se/whoson":FindLogonEvents is a complexType.
///
...
class _WhosOn__FindLogonEvents
{ public:
/// Element "filter" of XSD type "http://it.bmc.uu.se/whoson":LogonEvent.
    WhosOn__LogonEvent*                  filter                         1;	///< Required element.
/// Element "match" of XSD type "http://it.bmc.uu.se/whoson":LogonEventMatch.
    enum WhosOn__LogonEventMatch         match                          1;	///< Required element.
/// A handle to the soap struct that manages this instance (automatically set).
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://it.bmc.uu.se/whoson":FindLogonEventsResponse
/// @brief "http://it.bmc.uu.se/whoson":FindLogonEventsResponse is a complexType.
///
...
class _WhosOn__FindLogonEventsResponse
{ public:
/// Element "FindLogonEventsResult" of XSD type "http://it.bmc.uu.se/whoson":ArrayOfLogonEvent.
...
//gsoap LogonAccountingServiceSoap service namespace:	http://it.bmc.uu.se/whoson/LogonAccountingServiceSoap 
...
//gsoap LogonAccountingServiceSoap2 service namespace:	http://it.bmc.uu.se/whoson/LogonAccountingServiceSoap12 
...
name.
  ...
  - Action: "http://it.bmc.uu.se/whoson/CreateLogonEvent"

  - Addressing input action: "http://it.bmc.uu.se/whoson/CreateLogonEvent"

  - Addressing output action: "http://it.bmc.uu.se/whoson/CreateLogonEventResponse"
...
//gsoap LogonAccountingServiceSoap service method-input-action:	CreateLogonEvent http://it.bmc.uu.se/whoson/CreateLogonEvent
//gsoap LogonAccountingServiceSoap service method-output-action:	CreateLogonEvent http://it.bmc.uu.se/whoson/CreateLogonEventResponse
int __LogonAccountingServiceSoap__CreateLogonEvent(
...
Close an existing logon session identified by the event ID
  ...
  - Action: "http://it.bmc.uu.se/whoson/CloseLogonEvent"

  - Addressing input action: "http://it.bmc.uu.se/whoson/CloseLogonEvent"

  - Addressing output action: "http://it.bmc.uu.se/whoson/CloseLogonEventResponse"
...
//gsoap LogonAccountingServiceSoap service method-input-action:	CloseLogonEvent http://it.bmc.uu.se/whoson/CloseLogonEvent
//gsoap LogonAccountingServiceSoap service method-output-action:	CloseLogonEvent http://it.bmc.uu.se/whoson/CloseLogonEventResponse
int __LogonAccountingServiceSoap__CloseLogonEvent(
...
Deletes the logon event identified by the event ID.
  ...
  - Action: "http://it.bmc.uu.se/whoson/DeleteLogonEvent"

  - Addressing input action: "http://it.bmc.uu.se/whoson/DeleteLogonEvent"

  - Addressing output action: "http://it.bmc.uu.se/whoson/DeleteLogonEventResponse"
...
//gsoap LogonAccountingServiceSoap service method-input-action:	DeleteLogonEvent http://it.bmc.uu.se/whoson/DeleteLogonEvent
//gsoap LogonAccountingServiceSoap service method-output-action:	DeleteLogonEvent http://it.bmc.uu.se/whoson/DeleteLogonEventResponse
int __LogonAccountingServiceSoap__DeleteLogonEvent(
...
Find and return the logon event matching the request parameters.
  ...
  - Action: "http://it.bmc.uu.se/whoson/FindLogonEvent"

  - Addressing input action: "http://it.bmc.uu.se/whoson/FindLogonEvent"

  - Addressing output action: "http://it.bmc.uu.se/whoson/FindLogonEventResponse"
...
//gsoap LogonAccountingServiceSoap service method-input-action:	FindLogonEvent http://it.bmc.uu.se/whoson/FindLogonEvent
//gsoap LogonAccountingServiceSoap service method-output-action:	FindLogonEvent http://it.bmc.uu.se/whoson/FindLogonEventResponse
int __LogonAccountingServiceSoap__FindLogonEvent(
...
Find and return all logon events matching the filter and match options.
  ...
  - Action: "http://it.bmc.uu.se/whoson/FindLogonEvents"

  - Addressing input action: "http://it.bmc.uu.se/whoson/FindLogonEvents"

  - Addressing output action: "http://it.bmc.uu.se/whoson/FindLogonEventsResponse"
...
//gsoap LogonAccountingServiceSoap service method-input-action:	FindLogonEvents http://it.bmc.uu.se/whoson/FindLogonEvents
//gsoap LogonAccountingServiceSoap service method-output-action:	FindLogonEvents http://it.bmc.uu.se/whoson/FindLogonEventsResponse
int __LogonAccountingServiceSoap__FindLogonEvents(
...
//gsoap LogonAccountingServiceSoap2 service method-input-action:	CreateLogonEvent http://it.bmc.uu.se/whoson/CreateLogonEvent
//gsoap LogonAccountingServiceSoap2 service method-output-action:	CreateLogonEvent http://it.bmc.uu.se/whoson/CreateLogonEventResponse
int __LogonAccountingServiceSoap2__CreateLogonEvent(
    _WhosOn__CreateLogonEvent*          WhosOn__CreateLogonEvent,	///< Input parameter
    _WhosOn__CreateLogonEventResponse*  WhosOn__CreateLogonEventResponse	///< Output parameter
);
...
//gsoap LogonAccountingServiceSoap2 service method-input-action:	CloseLogonEvent http://it.bmc.uu.se/whoson/CloseLogonEvent
//gsoap LogonAccountingServiceSoap2 service method-output-action:	CloseLogonEvent http://it.bmc.uu.se/whoson/CloseLogonEventResponse
int __LogonAccountingServiceSoap2__CloseLogonEvent(
    _WhosOn__CloseLogonEvent*           WhosOn__CloseLogonEvent,	///< Input parameter
    _WhosOn__CloseLogonEventResponse*   WhosOn__CloseLogonEventResponse	///< Output parameter
);
...
//gsoap LogonAccountingServiceSoap2 service method-input-action:	DeleteLogonEvent http://it.bmc.uu.se/whoson/DeleteLogonEvent
//gsoap LogonAccountingServiceSoap2 service method-output-action:	DeleteLogonEvent http://it.bmc.uu.se/whoson/DeleteLogonEventResponse
int __LogonAccountingServiceSoap2__DeleteLogonEvent(
    _WhosOn__DeleteLogonEvent*          WhosOn__DeleteLogonEvent,	///< Input parameter
    _WhosOn__DeleteLogonEventResponse*  WhosOn__DeleteLogonEventResponse	///< Output parameter
);
...
//gsoap LogonAccountingServiceSoap2 service method-input-action:	FindLogonEvent http://it.bmc.uu.se/whoson/FindLogonEvent
//gsoap LogonAccountingServiceSoap2 service method-output-action:	FindLogonEvent http://it.bmc.uu.se/whoson/FindLogonEventResponse
int __LogonAccountingServiceSoap2__FindLogonEvent(
    _WhosOn__FindLogonEvent*            WhosOn__FindLogonEvent,	///< Input parameter
    _WhosOn__FindLogonEventResponse*    WhosOn__FindLogonEventResponse	///< Output parameter
);
...
//gsoap LogonAccountingServiceSoap2 service method-input-action:	FindLogonEvents http://it.bmc.uu.se/whoson/FindLogonEvents
//gsoap LogonAccountingServiceSoap2 service method-output-action:	FindLogonEvents http://it.bmc.uu.se/whoson/FindLogonEventsResponse
int __LogonAccountingServiceSoap2__FindLogonEvents(
    _WhosOn__FindLogonEvents*           WhosOn__FindLogonEvents,	///< Input parameter
    _WhosOn__FindLogonEventsResponse*   WhosOn__FindLogonEventsResponse	///< Output parameter
);
